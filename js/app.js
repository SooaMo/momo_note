          ...
          <div class="card ${cardCls}" id="card-${p.id}">
            ...
            <div class="card-footer">
              ...
              <div class="card-actions">
                <button class="toggle-btn ${knownCls}"   onclick="handleToggle(${p.id}, 'known')">✓ 알겠다</button>
                <button class="toggle-btn ${unknownCls}" onclick="handleToggle(${p.id}, 'unknown')">? 모르겠다</button>
